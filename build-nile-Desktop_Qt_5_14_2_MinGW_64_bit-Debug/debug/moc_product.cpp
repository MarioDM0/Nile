...
QT_MOC_LITERAL(1, 8, 12), // "sendPurchase"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 16) // "on_buyPB_clicked"

    },
    "Product\0sendPurchase\0\0on_buyPB_clicked"
};
...
void Product::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendPurchase((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->on_buyPB_clicked(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Product::*)(int , QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Product::sendPurchase)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Product::sendPurchase(int _t1, QString _t2)
{
